<template>
  ...
  <div class="invalid-feedback">
    ...
    <button class="btn btn-primary me-3" type="submit"  @click="categorypicked(category)"  >Search</button>
  </div>
  </div>
...
function searchbyCatagory (selectedCategory) {
  const endpoint = process.env.VUE_APP_BACKEND_BASE_URL + '/events/sort/' + selectedCategory
  const requestOptions = {
    method: 'GET',
    redirect: 'follow'
  }
...
export default {
  ...
  methods: {
    ...
    categorypicked: function (category) {
